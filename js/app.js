...
sixteenUnifiedBtn.addEventListener('click',function(){
    ...
    const setPrice = addPrice('ram-memory-cost',180)
...
ssdBtn256.addEventListener('click',function () {
    ...
    const setPrice = addPrice('storage-memory-cost',0)
...
const discountTotal = document.getElementById('promo-discount-total')
